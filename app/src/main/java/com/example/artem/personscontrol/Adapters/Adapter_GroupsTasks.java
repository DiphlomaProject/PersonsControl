...
public class Adapter_GroupsTasks extends BaseAdapter implements Filterable {

    Context context;
    Fragment fragment;
    ArrayList<GroupTasks> projects;
    ArrayList<GroupTasks> filterList;
    CustomFilterprojects customFilter;

    LayoutInflater layoutInflater;

    public Adapter_GroupsTasks(Context context, ArrayList<GroupTasks> projects, Fragment fragment) {
        ...
        convertView.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if(fragment != null)
                    ...
                    ((TasksGroupsFragment)fragment).ShowSelectedUserInfo( projects.get(position));
            }
        });
    ...
    class CustomFilterprojects extends Filter {
        ...
        protected FilterResults performFiltering(CharSequence constraint) {
            ...
            if(constraint != null && constraint.length() > 0){
                ...
                ArrayList<GroupTasks> user_firebaseListFiltered = new ArrayList<>();
        ...
        protected void publishResults(CharSequence constraint, FilterResults results) {
            projects = (ArrayList<GroupTasks>) results.values;

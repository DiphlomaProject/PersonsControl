...
public class Adapter_ProjectsTasks extends BaseAdapter implements Filterable {

    Context context;
    Fragment fragment;
    ArrayList<ProjectTasks> projects;
    ArrayList<ProjectTasks> filterList;
    CustomFilterprojects customFilter;

    LayoutInflater layoutInflater;

    public Adapter_ProjectsTasks(Context context, ArrayList<ProjectTasks> projects, Fragment fragment) {
        ...
        convertView.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if(fragment != null)
                    ...
                    ((TasksProjectsFragment)fragment).ShowSelectedUserInfo( projects.get(position));
            }
        });
    ...
    class CustomFilterprojects extends Filter {
        ...
        protected FilterResults performFiltering(CharSequence constraint) {
            ...
            if(constraint != null && constraint.length() > 0){
                ...
                ArrayList<ProjectTasks> user_firebaseListFiltered = new ArrayList<>();
        ...
        protected void publishResults(CharSequence constraint, FilterResults results) {
            projects = (ArrayList<ProjectTasks>) results.values;
